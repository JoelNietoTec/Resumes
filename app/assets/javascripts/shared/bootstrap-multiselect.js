    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group"><span class="input-group-addon"><i class="fa fa-search-plus text-default"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
