class Profile < ActiveRecord::Base
  ...
  validates :email, :professional_title, :address, :birth_date, :presentation, presence: { message: 'Completa este campo' }, on: :update
  validates :surnames, :forenames, presence: { message: 'Completa este campo' }
